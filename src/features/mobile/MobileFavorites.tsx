...
import nopiFavorite from '../../assets/nopi/nopi-favorite.png';
...
export function MobileFavorites() {
  ...
  return <div className="mobile-page m-favorites"><MobileHeading image={nopiFavorite} eyebrow={uiText("나의 여행 컬렉션")} title={uiText(<>{uiText("마음에 담은")}<br/><em>{uiText("여행")}</em></>)} description={uiText("찜한 장소와 코스를 모아봤어요.")}/>

...
export function MobileFavorites() {
  ...
  return <div className="mobile-page m-favorites"><MobileHeading eyebrow="나의 여행 컬렉션" title={uiText(<>마음에 담은<br/><em>여행</em></>)} description="찜한 장소와 코스를 모아봤어요."/>
